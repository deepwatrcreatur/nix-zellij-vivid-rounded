      ...
      layout {
          pane size=1 borderless=true {
              plugin location="file:${zjstatus-wasm}" {
                  ...
                  // Active: Green Index, Surface1 (Brighter) Name
                  tab_active   "#[fg=#a6e3a1,bg=#181825]#[fg=#181825,bg=#a6e3a1,bold] {index} #[fg=#cdd6f4,bg=#45475a,bold] {name} #[fg=#45475a,bg=#181825] "
